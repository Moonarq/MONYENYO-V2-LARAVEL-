...
// const promoHTML = 'CLICK PROMO SPESIAL!'
  ...
  useEffect(() => {
    fetch(API_ENDPOINTS.PRODUCTS)
      ...
      .then(data => {
        setMenuItems(
          data
            .slice(0, 3) // hanya tampilkan 3 menu pertama
            .map(item => ({
              ...item,
              name: t(item.name),
      ...
      <div className="container">
        <div className="menu-section-header">
          ...
          <p className="menu-section-description">
            {t(
              'Nikmati kreasi kuliner khas kami dengan bahan terbaik dan rasa istimewa untuk pengalaman camilan tak terlupakan.'
            )}
          </p>
        </div>
              ...
              >
                <div className="menu-section-image">
                  ...
                  <div className="menu-section-overlay">
                    <div className="menu-section-price">
                ...
                <div className="menu-section-content">
                  <h3 className="menu-section-name">
                    {item.name}
                  </h3>
                  ...
                  <div className="menu-section-details">
                    <span className="menu-section-category">
                      {item.category}
                    </span>
        ...
        <div className="menu-section-cta">
          <Link to="/menu" className="menu-section-btn">
            {t('Lihat Semua Menu')}
          </Link>
        </div>
      </div>
